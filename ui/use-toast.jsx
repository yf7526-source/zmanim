...
const scheduleAutoDismiss = (toastId, duration = TOAST_AUTO_DISMISS_DELAY) => {
...
export const reducer = (state, action) => {
  switch (action.type) {
    ...
    case actionTypes.UPDATE_TOAST:
      if (action.toast.duration !== undefined) scheduleAutoDismiss(action.toast.id, action.toast.duration);
      return {
        ...state,
    ...
    case actionTypes.REMOVE_TOAST:
      if (action.toastId === undefined) {
        ...
        autoDismissTimeouts.forEach(clearTimeout);
        toastTimeouts.clear();
